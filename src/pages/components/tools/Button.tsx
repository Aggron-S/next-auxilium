        ...
        <>
          ...
          {auth?.currentUser?.uid !== undefined ? (
            <>
              ...
              {isShowMenu && (
                <Card outside="fixed top-52 right-20" inside="flex flex-col justify-center items-center bg-gradient-to-br from-[#669999] from-35% to-[#FF6633] rounded-lg shadow-md">
